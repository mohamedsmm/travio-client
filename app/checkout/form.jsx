...
import { api, get_session, remove_session, set_session, print, seconds_to_date } from "@/public/script/public";
import { useEffect, useState } from 'react';
import { useRouter } from "next/navigation";
import $ from "jquery";

export default function Form ({ data, tour, setFlash }) {
    ...
    const confirm_pay = async() => {
        ...
        const { error } = await stripe.confirmPayment({
            elements,
            confirmParams: {return_url: `${location.protocol}//${location.host}/checkout`},
        });
    ...
    const pay_now = async(_) => {
        ...
        let details = {
            ...
            paid_date: seconds_to_date(_.created),
            paid_price: _.amount / 100,
            paid_secret: _.client_secret,
            paid_currency: _.currency,
            paid_status: _.status === 'succeeded',
            pay_now: true,
        }
    ...
    useEffect(() => {
        ...
        stripe.retrievePaymentIntent(clientSecret).then((_) => {

            if ( _.paymentIntent.status === 'succeeded' ) pay_now(_.paymentIntent)
        ...
        <form>
            ...
            <div className="selectPaymentMethod__3Vbr">
                ...
                <div className="checkoutAccordion__5jm0">
                    ...
                    <div className="checkoutAccordionItemHeader__G5v8 credit-payment" onClick={_ => setPay('now')}>

                        <div className="checkoutAccordionItemRadio__3Ph-">

                            <div className={`dummyRadioButton__3s4A ${pay === 'now' && 'checked__RrLR'}`}>
            ...
            <div className="actions full-width">
                {
                    pay === 'now' ?
                    <button type="button" onClick={confirm_pay} className="button__3DBl fill__3uxT md__3J_k fillWidth__82Bn">
                    ...
                    pay === 'later' ?
                    <button type="button" onClick={pay_later} className="button__3DBl fill__3uxT md__3J_k fillWidth__82Bn">
                        Pay Later
                    </button> :
